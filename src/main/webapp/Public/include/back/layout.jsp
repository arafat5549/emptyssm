		 ...
		 <div class="sidebar-collapse">
		 	<ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="#">
                        <i class="fa fa-diamond"></i>
                        <span class="nav-label">解决方案管理</span>
                        <span class="fa arrow"></span>
                    </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${context }/admin/solution?method=list" data-index="0">解决方案列表</a>
                            </li>
                        </ul>
                </li>
 				...
 				<li>
                    <a href="#">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="${context }/admin/news?method=list" data-index="0">新闻列表</a>
                            </li>
                        </ul>
                </li>
                ...
                <li>
                    <a href="#">
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="J_menuItem" href="${context }/admin/comment?method=list" data-index="0">评论列表</a>
                            </li>
                        </ul>
                </li>
